...
// [ ESAME 2024-06-28
/// @ingroup esame
/// @note se un processo master o slave termina dobbiamo risvegliare l'eventuale
/// partner in attesa. Quando termina il master deallochiamo anche la memoria
/// allocata in cp_prep().
	if (des_cp *cp = p->cp) {
...
/**
 * @brief Parte C++ della primitiva cp_prep().
 *
...
/**
 * @brief Parte C++ della primitiva cp_get()
 *
 * @param regs		Puntatore al vettore di registri.
 */
extern "C" void c_cp_get(natq *regs)
{
/// @todo Realizzare la funzione c_cp_get
...
{
/// @todo Realizzare la funzione maybe_cp
// ( SOLUZIONE 2024-06-28
//   SOLUZIONE 2024-06-28 )
}
//   ESAME 2024-06-28 )
