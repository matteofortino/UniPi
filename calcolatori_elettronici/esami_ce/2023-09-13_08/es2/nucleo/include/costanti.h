/// @file costanti.h
/// @brief File incluso da tutti i moduli, sia nella parte C++ che nella parte
/// assembler.

/// @name limiti modificabili
///
/// Queste costanti definiscono alcune dimensioni o valori che possono essere
/// modificati liberamente, entro limiti ragionevoli.
/// @{
...
// [ ESAME 2023-09-13
#define I_UTN_W 384 ///< prima entrata zona cow
#define I_UTN_P                                                                \
  448 ///< prima entrata utente/privata (spostata per far spazio alla zona cow)
//   ESAME 2023-09-13 ]
...
// [ ESAME 2023-09-13
#define N_UTN_W 64 ///< numero entrate zona cow
#define N_UTN_P                                                                \
  64 ///< numero entrate utente/privata (diminuita per far spazio alla zona cow)
//   ESAME 2023-09-13 ]
/// @}
//   ESAME 2023-09-13 )
...
#define MAX_PRIORITY                                                           \
  (MIN_EXT_PRIO - 1)     ///< priorità massima dei processi (non esterni)
#define MIN_PRIORITY 0x1 ///< priorità minima dei processi
#define MAX_EXT_PRIO                                                           \
  (MIN_EXT_PRIO + 0xFE) ///< priorità massima dei processi esterni
