...
/**
 * @brief Lettura asincrona dalla periferica CE
 *
 * @param id		id della periferica
 * @param buf		buffer destinato a ricevere i byte letti
 ...
 * @pre Il buffer deve essere accessible dal processo esterno.
 * @pre _quanti_ deve essere maggiore di zero.
 *
 * @return identificatore di trasferimento, o 0xFFFFFFFF in caso di errore
 */
extern "C" natl ceasyncread_n(natl id, char *buf, natl quanti);

/**
 * @brief Attende il termine di un trasferimento da una periferca CE
 *
 * @param id		id della periferca
 * @param trid		identificatore del traferimento
 * @pre La periferica deve esistere.
 * @pre Il trasferimento deve essere pendente.
 */
extern "C" void cewait(natl id, natl trid);
//   ESAME 2025-09-10 )
