...
/// @ingroup esame
#define MAX_CE			16
/// @brief Massimo numero di trasferimenti pendenti per periferica CE
/// @ingroup esame
#define MAX_CE_ASYNC		4
//   ESAME 2025-09-10 ]
...
#define IO_TIPO_CEAR		0x4a	///< ceasyncread_n()
#define IO_TIPO_CEW		0x4b	///< cewait()
//   ESAME 2025-09-10 )
/// @}
/// @}
