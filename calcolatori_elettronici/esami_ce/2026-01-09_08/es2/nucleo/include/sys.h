...
/**
 * @brief Estrae un gettone da più semafori contemporaneamente.
 *
 * @pre tutti i semafori devono esistere ed essere accesibili
 * 	dal processo invocante.
 * @pre la dimensione dell'array non deve superare @ref MAX_MULTIWAIT
 * @pre l'array non deve causare problemi di Cavallo di Troia.
 *
 * @param sems		array contente gli id dei semaofori
 * @param n		dimensione dell'array di id
 */
extern "C" void sem_multiwait(natl *sems, natl n);
//  ESAME 2026-01-09 )
