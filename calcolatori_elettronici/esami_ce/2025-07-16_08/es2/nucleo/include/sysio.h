...
/**
 * @brief Cambia lo stato di residenza del processo.
 *
 * @param res se true, rende il processo residente; se
 * 	      false, lo rende non residente.
 */
extern "C" void resident(bool res);
