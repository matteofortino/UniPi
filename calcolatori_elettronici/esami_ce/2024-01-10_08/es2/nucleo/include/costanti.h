...
#define TIPO_WTO		0x2a	///< sem_wait_to()
#define TIPO_CEDEBUG		0x2b	///< cedebug() (per debug e test)
#define TIPO_CEREADTO		0x2c	///< ceread_n_to()
//   ESAME 2024-01-10 )
/// @}
...
#define INTR_TIPO_CE		0xa0	///< periferiche CE
//   ESAME 2024-01-10 )
/// @}
