...
/// Massimo numero di RW
#define MAX_RW			100
/// Massimo numero di lettori per ogni RW
#define MAX_RW_READERS		4
// ESAME 2026-01-28 )
/// @}
...
#define TIPO_AW			0x2a	///< rw_acq_write()
#define TIPO_AR			0x2b	///< rw_acq_read()
#define TIPO_RW			0x2c	///< rw_rel_write()
#define TIPO_RR			0x2d	///< rw_rel_read()
#define TIPO_IRW		0x2e	///< rw_init()
// ESAME 2026-01-28 )
/// @}
