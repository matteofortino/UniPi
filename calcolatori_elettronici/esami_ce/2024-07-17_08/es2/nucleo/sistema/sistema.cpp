...
struct des_proc {
  ...
  bool bloccato;
  /// è arrivata una richiesta di interruzione mentre il processo non era
  /// bloccato nella wfi()
  bool ricevuto_intr;
  /// @}
  //   ESAME 2024-07-17 )
...
extern "C" void c_terminate_p(bool logmsg) {
  ...
  // [ ESAME 2024-07-17
  /// @ingroup esame
  /// @note Rispondiamo ad eventuali notifiche pendenti se il processo era
  /// registrato.
  ...
  /// @ingroup esame
  /// @note Se necessario, notifichiamo la terminazione e rimandiamo la
...
/**
 * @brief Chiamata da wfi() per controllare la presenza di notifiche e/o
 * interrupt pendenti.
 *
 * Se questa funzione restituisce true, wfi() non bloccherà il processo.
 *
 * @return	true se il processo ha ricevuto una notifica e/o una richiesta
 * di interruzione, false altrimenti
 */
extern "C" bool maybe_event() {
  /// @todo completare maybe_event()
...
/**
 * @brief Chiamata dagli handler per segnalare una nuova richiesta di
 * interruzione.
 *
