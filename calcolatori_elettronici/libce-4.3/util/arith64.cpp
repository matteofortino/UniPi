...
extern "C" arith64_s64 __absvdi2(arith64_s64 a)
{
    return arith64_abs(a);
}

// Return the result of shifting a left by b bits.
extern "C" arith64_s64 __ashldi3(arith64_s64 a, int b)
{
...
extern "C" arith64_s64 __ashrdi3(arith64_s64 a, int b)
{
    arith64_word w = {.s64 = a};
...
extern "C" int __clzsi2(arith64_u32 a)
{
    int b, n = 0;
...
extern "C" int __clzdi2(arith64_u64 a)
{
    int b, n = 0;
...
extern "C" int __ctzsi2(arith64_u32 a)
{
    int b, n = 0;
...
extern "C" int __ctzdi2(arith64_u64 a)
{
    int b, n = 0;
...
extern "C" arith64_u64 __divmoddi4(arith64_u64 a, arith64_u64 b, arith64_u64 *c)
{
...
extern "C" arith64_s64 __divdi3(arith64_s64 a, arith64_s64 b)
{
...
extern "C" int __ffsdi2(arith64_u64 a)
{
    return a ? __ctzdi2(a) + 1 : 0;
}

// Return the result of logically shifting a right by b bits.
extern "C" arith64_u64 __lshrdi3(arith64_u64 a, int b)
{
...
extern "C" arith64_s64 __moddi3(arith64_s64 a, arith64_s64 b)
{
    arith64_u64 r;
...
extern "C" int __popcountsi2(arith64_u32 a)
{
...
// Return the number of bits set in a.
extern "C" int __popcountdi2(arith64_u64 a)
{
    // collect sums into two low bytes
...
extern "C" arith64_u64 __udivdi3(arith64_u64 a, arith64_u64 b)
{
    return __divmoddi4(a, b, nullptr);
}

// Return the remainder of the unsigned division of a and b.
extern "C" arith64_u64 __umoddi3(arith64_u64 a, arith64_u64 b)
{
    arith64_u64 r;
    __divmoddi4(a, b, &r);
    return r;
