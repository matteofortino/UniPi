...
\subsection{Circuito rettificatore con condensatore}
...
\begin{center}
	\includegraphics[scale=0.3]{../images/rect_cap.png}
\end{center}
\begin{enumerate}
...
\begin{center}
	\includegraphics[scale=0.3]{../images/rect_rc.png}
\end{center}

Chiamiamo questo voltaggio di caduta \textbf{ripple} voltage del rettificatore.

\subsection{Circuito rettificatore a doppia semionda}
...
\begin{center}
	\includegraphics[scale=0.3]{../images/rect_trans.png}
\end{center}
...
\subsection{Circuito rettificatore a doppia semionda con filtro RC}
...
\begin{center}
	\includegraphics[scale=0.3]{../images/rect_transcap.png}
\end{center}

\subsection{Rettificatore a ponte di Graetz}
...
\subsection{Rettificatore a ponte di Graetz con filtro RC}
...
\subsection{Confronto fra tra presa centrale e ponte di Graetz}
...
\subsection{Rettificatore con diodo Zener}
...
\begin{center}
	\includegraphics[scale=0.25]{../images/zener.png}
\end{center}
